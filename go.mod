...
replace cosmossdk.io/log => cosmossdk.io/log v1.4.1

require (
	github.com/CosmWasm/wasmd v0.61.8
	github.com/classic-terra/core/v4 v4.0.1-patch.3
...
require (
	...
	github.com/cosmos/ibc-apps/modules/ibc-hooks/v10 v10.0.0-20250826214904-d53749a559f6 // indirect
...
replace (
	...
	//github.com/gogo/protobuf => github.com/cosmos/gogoproto v1.4.10
	github.com/gogo/protobuf => github.com/regen-network/protobuf v1.3.3-alpha.regen.1
	github.com/jhump/protoreflect => github.com/jhump/protoreflect v1.9.0
)

replace (
	// use cometbft v0.8.0 - mantlemint needs bigger rework to upgrade to cometbft v0.11.0
